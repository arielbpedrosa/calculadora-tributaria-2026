...
- Suporte a mais regimes tributários (Lucro Presumido, MEI)
- Dashboard com histórico visual e gráficos das comparações salvas
- Exportação de relatórios em PDF com os dados do usuário
- Validação avançada de campos no frontend
- Deploy em ambiente de produção (ex: Vercel + Railway)
